 ...
 * @Vesion 1.0
 */
public abstract class ClickhouseDefaultRepository<E>  {
    ...
    public ClickhouseDefaultRepository(DatabaseOperator operator, Supplier<RDBTableMetadata> supplier, ResultWrapper<E, ?> wrapper) {
